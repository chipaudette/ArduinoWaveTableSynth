...
void dacWriteOneChannel(const int &slavePin,const int &value) {
  //int value = 0;
  //byte configByte = 0;
  static const byte configByte =  B01110000; //channel 0, Vref buffered, Gain of 1x, Active Mode
  byte data=0;
  ...
  //  }
    ...
    //write first byte
    data = highByte(value);
    data &= B00001111;  //clear out the 4 command bits and set the command bits
